...
class BANDSEL
{
  public:
    ...
    bool begin(class PCA9554 *p_bpf, class PCA9554 *p_lpf, void (*event_callback)(uint32_t, uint8_t, event_data), BANDS p_init_band = BAND_20M );
  ...
  private:
    ...
    void (*ev_cb)(uint32_t, uint8_t, event_data);
    class PCA9554 *bpf;
    class PCA9554 *lpf;
